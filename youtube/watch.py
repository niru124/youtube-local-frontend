    ...
    return flask.render_template(template_name,
        ...
        js_data = {
            ...
            **source_info,
            ...
            'sb_sponsor': getattr(settings, 'sponsorblock_sponsor', True),
            'sb_sponsor_color': getattr(settings, 'sponsorblock_sponsor_color', '#a6d189'),
            'sb_intro': getattr(settings, 'sponsorblock_intro', True),
            'sb_intro_color': getattr(settings, 'sponsorblock_intro_color', '#89cff0'),
            'sb_outro': getattr(settings, 'sponsorblock_outro', True),
            'sb_outro_color': getattr(settings, 'sponsorblock_outro_color', '#f0e68c'),
            'sb_preview': getattr(settings, 'sponsorblock_preview', True),
            'sb_preview_color': getattr(settings, 'sponsorblock_preview_color', '#deb887'),
            'sb_selfpromo': getattr(settings, 'sponsorblock_selfpromo', True),
            'sb_selfpromo_color': getattr(settings, 'sponsorblock_selfpromo_color', '#dda0dd'),
            'sb_exclusive_access': getattr(settings, 'sponsorblock_exclusive_access', False),
            'sb_exclusive_access_color': getattr(settings, 'sponsorblock_exclusive_access_color', '#daa520'),
            'sb_interaction': getattr(settings, 'sponsorblock_interaction', True),
            'sb_interaction_color': getattr(settings, 'sponsorblock_interaction_color', '#ff9966'),
            'sb_music_offtopic': getattr(settings, 'sponsorblock_music_offtopic', False),
